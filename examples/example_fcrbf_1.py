...
import numpy as np
import rosenpy.model.fcrbfnn as mynn
...
# Create an instance of the FCRBF Neural Network
nn = mynn.FCRBFNN(gpu_enable=False)

# Add layers to the network
nn.add_layer(ishape=input_data.shape[1], neurons=20, oshape=output_data.shape[1], gamma_rate=1e-3, sigma_rate=1e-3)

# Train the neural network using the fit method
nn.fit(input_data, output_data, epochs=500, verbose=100, batch_size=100)
