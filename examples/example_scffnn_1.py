...
import numpy as np
import rosenpy.model.scffnn as mynn
...
# Create an instance of the SCFF Neural Network
nn = mynn.SCFFNN(gpu_enable=False)

# Add layers to the network
nn.add_layer(ishape=input_data.shape[1], neurons=30)
